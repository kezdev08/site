  ...
  return (
    ...
    <div className="w-[400px]  h-screen flex flex-col items-center justify-center">
      ...
      <div id="card" className={`${cardClass}`} onClick={toggleCard}>     
        <div id="card-inside">
          <div className="wrap">
            <p>La multi ani tat!</p>
            <p>Multa sanatate si la cati mai multi ani.</p>
            <p>
              
            </p>
            <p>
              La cat mai multi bani si mai putin lucru si masine de care vrei.
            </p>
            <p>
              Si inca odata La multi ani.
            </p>
            <p className="signed">Cu drag, Cezar</p>
          </div>
        </div>
